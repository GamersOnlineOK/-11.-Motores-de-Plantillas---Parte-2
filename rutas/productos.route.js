...
router.get('/productos/listar', (req, res) => {
    var productos = fs.promises.readFile(FILE_PRODUCTOS)
        ...
        .then(datos => {
            ...
            // {json.length>0?(res.render("main",{json , listExist:true})):(res.render("main",{listExist:false}))} HANDLEBAR
            {json.length>0?(res.render("index",{json , listExist:true})):(res.render("index",{listExist:false}))}
